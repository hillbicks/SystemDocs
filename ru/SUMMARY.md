...
* [Что это за сеть?](what_it_is/README.md)
   * [Данные в SAFE Network](what_it_is/data_on_the_safe_network.md)
   * [Программы и приложения в SAFE Network](what_it_is/apps_and_programs_on_the_safe_network.md)
   * [Доступ к SAFE Network](what_it_is/costs_of_using_the_safe_network.md)
   * [Хранилища (Vaults)](what_it_is/vaults.md)
   * [Safecoins](what_it_is/safecoins.md)
   * [Кошельки (Wallets)](what_it_is/wallets.md)
* [Как она работает?](how_it_works/README.md)
   * [Безопасность - самошифрование](system_components/self_encryption.md)
   * [Упругая автономная сеть](system_components/autonomous_network.md)
       * [Криптографическая защита](system_components/cryptographically_secure.md)
       * [Достоверная идентификация хранилища](system_components/guaranteed_vault_identification.md)
       * [Точная оценка близости p2p сети](system_components/accurate_p2p_network_proximity_assessment.md)
       * [Роутеры с соединением в обе стороны](system_components/routers_with_connections_both_ways.md)
       * [Proof of resource](system_components/proof_of_resources.md)
       * [Оценка и награждение](system_components/measurement_and_reward.md)
       * [Текучесть сети](system_components/network_churn.md)
       * [Отсутствие администраторов](system_components/remove_administration.md)
   * [(nt finshd) Эффективность - самоидентификация](system_components/self_authentication.md)
   * [(nt finshd) Хранилища (Vaults)](how_it_works/vault.md)
...
* [Как ее использовать?](how_to_use_it/README.md)
...
* [Принять участие](get_involved/README.md)
