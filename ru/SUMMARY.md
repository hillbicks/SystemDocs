...
* [Как она работает?](how_it_works/README.md)
   ...
   * [Упругая автономная сеть](system_components/autonomous_network.md)
       ...
       * [(nt finshd)Proof of resource](system_components/proof_of_resources.md)
       * [(nt finshd) Оценка и награждение](system_components/measurement_and_reward.md)
       * [(nt finshd) Текучесть сети](system_components/network_churn.md)
